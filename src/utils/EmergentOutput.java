...
public class EmergentOutput extends javax.swing.JFrame {
     ...
     */
    ArrayList<String> metric_list,

    /**
     * Creates new form EmergentOutput
     */
    metric_list1,
    ...
    // multilabel datasets
    public EmergentOutput(ArrayList<String> metric_list ,ArrayList<MultiLabelInstances> list_datasets, ArrayList<String> dataset_names , ArrayList<Boolean> es_de_tipo_meka )
    {
    ...
    public EmergentOutput(ArrayList<String> metric_list_comun, ArrayList<String> metric_list_train, ArrayList<String> metric_list_test , ArrayList<MultiLabelInstances> list_datasets_train, ArrayList<MultiLabelInstances> list_datasets_test, int posx, int posy, boolean es_de_tipo_meka)
    {
       ...
       //metrics train
        ...
        ImbalancedFeature[] imbalanced_data;
        ImbalancedFeature[] imbalanced_data1;
        
        ImbalancedFeature [] label_frequency,label_frequency1;
        flag =true;
    ...
    public EmergentOutput(MultiLabelInstances dataset , int posx, int posy,String[] args, ArrayList<String> labelnames, ImbalancedFeature[] label_frequency, boolean es_de_tipo_meka)
    {
    ...
    public EmergentOutput(MultiLabelInstances dataset , int posx, int posy, ArrayList<String> labelnames, ImbalancedFeature[] label_frequency, boolean es_de_tipo_meka)
    {
        this.dataset = dataset;
        this.posx = posx;
        this.posy = posy;
    ...
    // Tab "Dataset"
    public EmergentOutput(ArrayList<String> metric_list, MultiLabelInstances dataset , int posx, int posy, boolean es_de_tipo_meka) {
    ...
    public EmergentOutput(MultiLabelInstances dataset , String label1, String label2, int posx, int posy , boolean es_de_tipo_meka )
    {
        this.posx = posx;
        this.posy = posy;
        this.es_de_tipo_meka = es_de_tipo_meka;
    ...
    //para pestaña TRAIN/TEST holdout
     public EmergentOutput(ArrayList<String> metric_list_comun,ArrayList<String> metric_list_train,ArrayList<String> metric_list_test, MultiLabelInstances dataset_train , MultiLabelInstances dataset_test , int posx, int posy, boolean es_de_tipo_meka) {
        ...
        ImbalancedFeature[] label_frenquency = util.Get_Frequency_x_label(dataset_train);
        label_frenquency = util.Ordenar_freq_x_attr(label_frenquency);// ordena de mayor a menor
             
        ImbalancedFeature[] imbalanced_data =  util.Get_data_imbalanced_x_label_inter_class(dataset_train,label_frenquency);
     ...
     private void print_information1(ArrayList<String> labelnames, ImbalancedFeature[] label_frequency)
    {
        String tabs ="\t"+"\t" +"\t";
        String tabs1 = "\t";
        this.es_de_tipo_meka = es_de_tipo_meka;
