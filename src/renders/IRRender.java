...
public class IRRender extends DefaultTableCellRenderer
{
    ...
    public IRRender(int posicion_IR){ this.posicion_IR = posicion_IR;}
    
    public IRRender(int posicion_IR, int posicion_IR_2){ this.posicion_IR = posicion_IR; this.posicion_IR_2 =posicion_IR_2;}
