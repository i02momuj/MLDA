 ...
 xyplot.setDataset(xyseriescollection);
   ...
   public static void update_values_line_chart(double[] id_x_IR ,int[] id_x_nums_label, CategoryPlot cp)
    ...
    public static boolean Esta_el_valor (double[] visitados , double actual)
     ...
     public static ImbalancedFeature Devuelve_Mayor_IR_inter_class(ImbalancedFeature[] imbalanced_data, ArrayList<String> visitados)
     {
         ...
         return mayor;
          ...
          public static ImbalancedFeature Devuelve_Menor_IR(ImbalancedFeature[] imbalanced_data, ArrayList<String> visitados)
     {
    ...
    public static double get_q3(double[] arreglo_ordenado)
     ...
     public static ImbalancedFeature[] Sort_data_imbalance_Mayor_IR_intra_class(ImbalancedFeature[] imbalanced_data)
     {
        ImbalancedFeature[] ordenados = new ImbalancedFeature[imbalanced_data.length];
        ...
        return ordenados;
          ...
          public static ImbalancedFeature[] Sort_data_imbalance_Mayor_IR_inter_class(ImbalancedFeature[] imbalanced_data)
     {
        ImbalancedFeature[] ordenados = new ImbalancedFeature[imbalanced_data.length];
        ...
        return ordenados;
          ...
          public static ImbalancedFeature[] Sort_data_imbalance_Menor(ImbalancedFeature[] imbalanced_data)
     {
        ImbalancedFeature[] ordenados = new ImbalancedFeature[imbalanced_data.length];
    ...
    public static ImbalancedFeature[] Get_data_imbalanced_x_label_inter_class( MultiLabelInstances dataset, ImbalancedFeature[] label_frequency)
    {
        int[] label_indices= dataset.getLabelIndices();
        
        ImbalancedFeature[] labels_imbalanced = new ImbalancedFeature[label_indices.length];
        ...
        Instances Instancias = dataset.getDataSet();
         ...
         Attribute current; //para obtener el ImbalancedFeature de la primera instancia
         ImbalancedFeature current_label_freq;
        
         
         for(int i=0; i<label_indices.length;i++)//recorre por etiquetas
         {
             current= Instancias.attribute(label_indices[i]); // ImbalancedFeature actual
        ...
        public static ImbalancedFeature[] Get_data_imbalanced_x_label( MultiLabelInstances dataset)
    {
        int[] label_indices= dataset.getLabelIndices();
        ...
        Instances Instancias = dataset.getDataSet();
         ...
         for(int i=0; i<label_indices.length;i++)//recorre por etiquetas
         {
           ...
           catch(Exception e1)
           {
             ...
             labels_imbalanced[i]= new ImbalancedFeature(current.name(), ir, variance);
    ...
    public static ImbalancedFeature[] Get_Frequency_x_label( MultiLabelInstances dataset)
    {
        int[] label_indices= dataset.getLabelIndices();
        
        ImbalancedFeature[] frequencia_x_labels = new ImbalancedFeature[label_indices.length];
        ...
        Instances Instancias = dataset.getDataSet();
         ...
         for(int i=0; i<label_indices.length;i++)
         {
             ...
             frequencia_x_labels[i]= new ImbalancedFeature(current.name(), frequency);
             frequency=0;
         }
    ...
    public static ImbalancedFeature[] Ordenar_freq_x_attr (ImbalancedFeature[] label_frenquency) // ordena de mayor a menor
    {
        ...
        ImbalancedFeature[] ordenado = new ImbalancedFeature [label_frenquency.length];
     ...
     public static ImbalancedFeature Devuelve_mayor( ArrayList<ImbalancedFeature> lista)
    {
    ...
    public static ImbalancedFeature Devuelve_menor( ArrayList<ImbalancedFeature> lista)
    {
    ...
    public static void Save_in_the_file_arff(PrintWriter wr,ArrayList<String> metric_list, ArrayList<MultiLabelInstances> list_datasets, String relation_name, boolean es_de_tipo_meka)
   {
    ...
    public static void Save_in_the_file_csv(PrintWriter wr,ArrayList<String> metric_list_comun, ArrayList<String>  metric_list_train, ArrayList<String> metric_list_test,ArrayList<MultiLabelInstances> list_dataset_train ,ArrayList<MultiLabelInstances> list_dataset_test, String dataset_current_name, boolean es_de_tipo_meka)
    {
        ...
        ImbalancedFeature[] imbalanced_data_train;
        ImbalancedFeature[] imbalanced_data_test;
   ...
   public static void Save_in_the_file_csv(PrintWriter wr,ArrayList<String> metric_list_comun, ArrayList<String>  metric_list_train, ArrayList<String> metric_list_test, MultiLabelInstances dataset_train , MultiLabelInstances dataset_test,String dataset_current_name, boolean es_de_tipo_meka)
   {
        Instances i1= dataset_train.getDataSet();
          ...
          //cant de ImbalancedFeatures
          
          int num_ImbalancedFeatures= i1.numAttributes();
          int numero_etiquetas = dataset_train.getNumLabels();
          
          //Attributes
          wr.write("Attributes;"+Integer.toString(num_ImbalancedFeatures-numero_etiquetas));
          wr.write(System.getProperty("line.separator"));   
        ...
        ImbalancedFeature[] imbalanced_data_train =  Util.Get_data_imbalanced_x_label(dataset_train); 
        ImbalancedFeature[] imbalanced_data_test =  Util.Get_data_imbalanced_x_label(dataset_test); 
   ...
   public static String Cambia_pto_x_coma(String valor)
   {
     ...
     public static void Save_in_the_file_txt(PrintWriter wr, ArrayList<String> metric_list, ArrayList<String> metric_list1, ArrayList<String> metric_list2 , ArrayList<MultiLabelInstances> list_datasets_train, ArrayList<MultiLabelInstances> list_datasets_test, boolean es_de_tipo_meka)
     {
       ...
       //metrics train
        ...
        ImbalancedFeature[] imbalanced_data,imbalanced_data1,label_frenquency,label_frenquency1;
        MultiLabelInstances current_train, current_test;
    ...
    public static void Save_in_the_file_csv(PrintWriter wr,ArrayList<String> metric_list, MultiLabelInstances current,String dataset_name, boolean es_de_tipo_meka)
   {
        ...
        encabezado+= ";"+dataset_name;
         ...
         ImbalancedFeature[] imbalanced_data =  Util.Get_data_imbalanced_x_label(current); 
   ...
   public static ImbalancedFeature Get_label_x_labelname(String labelname , ImbalancedFeature[] lista)
   {
   ...
   public static void Save_in_the_file(PrintWriter wr,ArrayList<String> metric_list, MultiLabelInstances dataset, ImbalancedFeature[] imbalanced_data, boolean  es_de_tipo_meka)
     {
        ...
        //ImbalancedFeature[] imbalanced_data =  Util.Get_data_imbalanced_x_label(dataset);
   ...
   public static void Save_text_file_multi(PrintWriter wr,ArrayList<String> metric_list, ArrayList<String> dataNames, Hashtable<String, Hashtable<String, String>> tableMetrics)
    ...
    public static ArrayList<String> Get_lista_vertices_del_par(String labelname, ArrayList<attributesPair> mi_lista)
    {
        ...
        {
            if(actual.getName_attr1()==labelname) 
            {
                result.add(actual.getName_attr2());
     
            }
           else if(actual.getName_attr2()==labelname)
           {
               result.add(actual.getName_attr1());
    ...
    private static String[] getName_label( int[] label_indices, Instances Instancias )
    {
    ...
    public static double[] getIRIntraClass_values_intra_class(ImbalancedFeature[] label_imbalanced)
    {
    ...
    public static double[] getIRIntraClass_values_inter_class(ImbalancedFeature[] label_freq)//se le pasa el arreglo ordenado de mayor a menor
    {
    ...
    private static int getAppearances_x_label_name(ImbalancedFeature[] lista_attr_freq ,String label_name)
    {
    ...
    private static ArrayList<attributesPair> conforma_attributesPair(int [] pares_etiquetas,int[] label_indices,MultiLabelInstances dataset )
    {
      ArrayList<attributesPair> mi_lista= new ArrayList<>();
      Instances Instancias = dataset.getDataSet();
      
      String[] name_attr =getName_label(label_indices, Instancias); //NOMBRES DE LAS ETIQUETAS
      attributesPair actual;
      
      ImbalancedFeature[] lista_attr_freq = Get_Frequency_x_label(dataset);
      int cant_i, cant_j;
      ...
      for(int i = 0; i<label_indices.length; i++)
      {
          for(int j=i+1 ; j<label_indices.length ; j++)
          {
            ...
            cant_i = getAppearances_x_label_name(lista_attr_freq, name_attr[i]);
            cant_j = getAppearances_x_label_name(lista_attr_freq, name_attr[j]);
    ...
    public static attributesPair Search_and_get(String par1, String par2,ArrayList<attributesPair> lista )
    {
      ...
      {
          if(par1.equals(current.getName_attr1()) && par2.equals(current.getName_attr2())) return current;
          else if (par2.equals(current.getName_attr1()) && par1.equals(current.getName_attr2())) return current;
      }
      return null;
    }
    ...
    */
    ...
    private static attributesPair Devuelve_el_par(String att1, String att2, ArrayList<attributesPair> lista)
    {
        for( attributesPair current : lista)
        {
            if(current.getName_attr1().equals(att1) && current.getName_attr2().equals(att2))return current;
            if(current.getName_attr1().equals(att2) && current.getName_attr2().equals(att1))return current;
        }
        return null;
    }
    ...
    public static ArrayList<attributesPair> Get_attributesPair(MultiLabelInstances dataset)
    {       
        Instances Instancias = dataset.getDataSet();
        ...
        int [] pares_etiquetas = new int[comb_posibles]; // se usa para guardar la cantidad de veces que ocurre un par de ImbalancedFeatures entre si, 
        ...
        return conforma_attributesPair(pares_etiquetas, label_indices, dataset);
    }
